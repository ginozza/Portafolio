...
function applyTheme(theme) {
    ...
    if (theme === 'dark') {
        ...
        toolsImage.src = "https://skillicons.dev/icons?i=git,github,linkedin,vscode,linux,bash,bootstrap,mysql,figma&theme=dark";
    } else {
        themeIcon.classList.replace('fa-sun', 'fa-moon');
        techImage.src = "https://skillicons.dev/icons?i=html,css,javascript,typescript,java,cpp,nodejs,python&theme=light";
        toolsImage.src = "https://skillicons.dev/icons?i=git,github,linkedin,vscode,linux,bash,bootstrap,mysql,figma&theme=light";
    }
}
...
themeToggle.addEventListener('click', () => {
    ...
    applyTheme(theme); // Aplicar el tema después de cambiarlo
});
